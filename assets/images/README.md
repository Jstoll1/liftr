# Liftr image collections

Use one subfolder per workout collection, with versioned exercise filenames. Keep all delivered files indexed in `assets/manifest.json`.
...
## Leg-day expansion candidates

Front squat, sumo squat, split squat, walking lunge, reverse step-up, single-leg Romanian deadlift, single-leg glute bridge, weighted hip thrust, prone hamstring curl, hip abduction, hip adduction, band lateral walk, and tibialis raise.

For a future instructional library, add separately reviewed start/end frames and movement cues. Avoid treating a single pose as a complete technique demonstration. Additional equipment and demonstrator variants should get distinct IDs rather than overwriting existing images.
